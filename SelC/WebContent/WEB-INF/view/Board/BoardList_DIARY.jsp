...
<body>
	...
	<script>
		function gotoCnt() {
			document.location.href="toBoard.do?bid="+arguments[0];
		}
		
// 		function refreshSrch() {
// 			alert(document.getElementById("srchOption").firstElementChild.value);
// 			var option = (document.getElementById("srchOption").firstElementChild.value);
// 		}
		...
		function gotoWrite() {
			if(arguments[0]==null){
				...
				document.location.href="gotoWrite_DIARY.do";
			}
		}
...
<!-- TABLE -->
	<div class="container">
		<img class="img-rounded" src="img/Board/Board_SelC.png" style="width: 100%; height: auto;"><br />
		<br />
	</div>
	<div class="container">
		<table class="table table-bordered table-hover" style="font-family:고도 M">
			<thead>
				<tr style="background-color:#0668a1; color:#ffffff">
					...
					<th width="18%" class="text-center">자기개발자</th>
					<th width="14%" class="text-center">등록일</th>
					<th width="7%" class="text-center">추천수</th>
			...
			<tr>
				...
				<td onclick="gotoCnt(${obj.bid});" style="padding-left:20px">
					ㆍ<c:out value="${obj.btitle}"/>
					<c:if test="${obj.bgrname eq '인기게시글'}">
						<i class="text-right" style="color:#7cc9d9;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-menu-up" aria-hidden="true"></i>인기인기!</i>
					</c:if>
					<c:if test="${obj.bgrname eq '베스트게시물'}">
						<i style="color:#0668a1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-chevron-up" aria-hidden="true"></i>베-스트</i>
					</c:if>
				</td>
		...
		<div class="container" style="line-height: 1em">
			...
			<div class="text-right" style="line-height: 1em;">
				<div id="srchOption">
				<select class="panel panel-primary" id="srchOptionS" name="srchOptionS" onchange="refreshSrch()"
				...
				<form name="goSrch" action ="goDiarySrch.do"  method="get" onsubmit="return getOptions()">
		...
		<div class="text-center">
			<ul class="pagination">
				...
				<li><a href="toBoardList_DIARY.do?page_number=${i.count}">${i.count}</a></li>
				</c:forEach>
			</ul>
		</div>
	<div id="footer"></div>	
