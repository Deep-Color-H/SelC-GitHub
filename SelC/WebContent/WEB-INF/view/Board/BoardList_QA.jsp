...
<title>Create Yourself, SelC : 질문게시판</title>
...
<div id="gnb"></div>
	...
	<script>
		function gotoCnt() {
			document.location.href="toQABoard.do?bid="+arguments[0];
		}
		...
		function gotoWrite() {
			if(arguments[0]==null){
				...
				document.location.href="gotoWrite_QA.do";
			}
		}
		function getOptions() {
...
<% 
	...
	ArrayList<QABoardVO> list = (ArrayList<QABoardVO>)res.get("RS_LIST_CUR");
...
<!-- TABLE -->
	<div class="container">
		<img class="img-rounded" src="img/Board/Board_QA.png" style="width: 100%; height: auto;"><br />
		<br />
	</div>
	<div class="container">
		<table class="table table-bordered table-hover" style="font-family:고도 M">
			<thead>
				<tr style="background-color:#0668a1; color:#ffffff">
					...
					<th width="8%" class="text-center">답변여부</th>
			...
			<tr>
				...
				<td class="text-center"><c:out value="${obj.bach}"/></td>
			...
			<div class="text-right" style="line-height: 1em;">
				...
				<form name="goSrch" action ="goQASrch.do"  method="get" onsubmit="return getOptions()">
		...
		<div class="text-center">
			<ul class="pagination">
				...
				<li><a href="toBoardList_QA.do?page_number=${i.count}">${i.count}</a></li>
				</c:forEach>
			</ul>
		</div>
